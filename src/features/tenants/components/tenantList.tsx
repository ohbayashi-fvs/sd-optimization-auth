    ...
    <table className="max-w-[53rem] mx-auto my-[4.5rem] border-collapse">
      <thead className="bg-[#FAFAFA]">
        <tr className="flex h-[3.5rem] border-solid border-[0.1rem] border-black border-opacity-[6%] border-t-0 border-x-0">
          <th className="flex items-center min-w-[10rem] pl-[1rem] mr-[1rem] text-start text-[1rem] font-bold">
            組織名
          </th>
          <th className="flex items-center min-w-[5rem] text-start text-[1rem] font-bold before:content-[''] before:inline-block before:mr-[1rem] before:border-solid before:border-[0.1rem] before:border-y-0 before:border-r-0 before:border-black before:border-opacity-[6%] before: before:h-[1.4rem]">
            操作
          </th>
        </tr>
      </thead>
